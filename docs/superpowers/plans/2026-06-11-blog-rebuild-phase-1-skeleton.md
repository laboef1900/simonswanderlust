...
- **Phase 2 — content migration:** WP REST export script, HTML→MDX conversion, all 9 stories × 2 + real about pages, referenced-image download, image storage decision (binaries-in-git policy vs. Cloudflare build needs — flagged in spec §6, decide with user).
