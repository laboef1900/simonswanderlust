...
const de = {
  ...
  'home.aboutTeaser.text': 'Ich bin Simon — unterwegs mit Notizbuch und Kamera. Ich dokumentiere echte Orte, ungeschönte Eindrücke und Abenteuer abseits der gewohnten Pfade.',
...
const en: Record<UIKey, string> = {
  ...
  'home.aboutTeaser.text': "I'm Simon — traveling with a camera and notebook. Documenting real places, unvarnished impressions, and journeys beyond standard tourist routes.",
